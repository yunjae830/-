...
$(document).ready(function(){
	...
	$('#regBtn').on("click", function(e){
		e.preventDefault();
		addForm.attr("action", "/board/mailbox/addMail");
		addForm.submit();
	});
	...
	$(".move").on("click", function(e){
		...
		actionForm.attr("action", "/board/mailbox/updateMail");
		actionForm.submit();
	});
   ...
   <%@ include file="header.jsp"  %>   
	...
	<div class="row">
  		...
  		<div class="p-2 border">
	  		<div class="card">
	    		<img class="card-img-top" src="/board/resources/img/template<c:out value="${mail.template }"/>.png" alt="Card image" style="width:100%;">
	      			<div class="card">
	      				<h4 class="card-title">${mail.title1 }</h4>
	      				<p style="overflow:hidden;"class="card-text">${mail.text1 }<br/>
  	...
  	<div class="container" style="margin-top: 40px;">
  		...
  		<div class="row">
  			...
  			<form id="addForm" action="/board/mailbox/addMail" method="post">
  				<input type="hidden" name="mno" value="${mno}"/>
  			</form>
  		<button class="btn btn-success" id="regBtn" type="submit">Add</button>
  		<button class="btn btn-primary" onclick="location.href='/board/main2.do'">Back to home</button>
  		</div>
	</div>
	<br><br><br><br>
